    ...
    return {
      ...
      setup: function() {
        ...
        this.outsideClickHandler = function(e) {
          if (!e.target.closest('.btn-dropdown') && !e.target.closest('.dropdown_pai')) {
            self.close();
          }
        };
        ...
        if (this.mediaItems.length > 0) this.mediaItems[0].classList.add('active');
        if (this.menuItems.length > 0) this.menuItems[0].classList.add('active');
      },
